...
const Contact = () => {
  return (
    <div className='relative'>
        ...
        <div className='bg-[#DBDBDB] px-6 py-10 sm:w-[653px] sm:rounded-lg mt-36'>
            <h2 className='u-h2 mb-5 sm:text-[48px]'>Get in touch</h2>
            <p className='u-body mb-6 sm:text-[20px]'>Feel free to contact me any time. I will get back to you as I can!</p>
        ...
        <div className='bg-[#164EF5] w-full h-[224px] px-10 py-8 text-white flex flex-col sm:rounded-lg bottom-[-250px] right-[-200px] justify-center sm:w-[537px] sm:h-[362px] sm:absolute'>
